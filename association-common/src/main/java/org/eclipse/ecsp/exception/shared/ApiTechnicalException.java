...
/**
 * Represents an exception that occurs during API technical operations.
 */
public class ApiTechnicalException extends RuntimeException {
    ...
    /**
     * Constructs a new ApiTechnicalException with the specified detail message.
     *
    ...
    /**
     * Constructs a new ApiTechnicalException with the specified code and detail message.
     *
    ...
    /**
     * Constructs a new ApiTechnicalException with the specified code, detail message, and error message.
     *
     * @param code         the error code
     * @param message      the detail message
    ...
    /**
     * Constructs a new ApiTechnicalException with the specified code, detail message, error message, and cause.
     *
     * @param code         the error code
     * @param message      the detail message
     * @param errorMessage the error message
