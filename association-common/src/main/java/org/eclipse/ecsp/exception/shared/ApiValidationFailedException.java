...
public class ApiValidationFailedException extends RuntimeException {
    ...
    /**
     * Constructs a new ApiValidationFailedException with the specified detail message.
     *
    ...
    /**
     * Constructs a new ApiValidationFailedException with the specified code and message.
     *
    ...
    /**
     * Constructs a new ApiValidationFailedException with the specified code, message, and error message.
     *
     * @param code         the error code
     * @param message      the detail message
    ...
    /**
     * Constructs a new ApiValidationFailedException with the specified code, message, error message, and cause.
     *
     * @param code         the error code
     * @param message      the detail message
     * @param errorMessage the error message
