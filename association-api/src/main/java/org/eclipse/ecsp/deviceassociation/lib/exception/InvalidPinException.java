...
/**
 * Exception thrown when an invalid PIN is encountered during device association.
 */
@NoArgsConstructor
public class InvalidPinException extends RuntimeException {
    ...
    /**
     * Constructs a new InvalidPinException with the specified detail message and cause.
     *
     * @param message the detail message
