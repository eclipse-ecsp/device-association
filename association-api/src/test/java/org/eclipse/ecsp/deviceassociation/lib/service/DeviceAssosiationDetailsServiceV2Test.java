...
/**
 * Test class for DeviceAssosiationDetailsServiceV2.
 */
public class DeviceAssosiationDetailsServiceV2Test {
    public static final long ID = 99L;

    @InjectMocks
    DeviceAssosiationDetailsServiceV2 deviceAssosiationDetailsServiceV2;
    ...
    public void getDeviceAssosiationDetails_NullUserId() {
        assertThrows(ApiValidationFailedException.class,
            () -> deviceAssosiationDetailsServiceV2.getDeviceAssosiationDetails(null));
    }

    @Test
    public void getDeviceAssosiationDetails_NullDetailsList() {
        ...
        List<DeviceAssosiationDetails> deviceAssosiationDetails =
                deviceAssosiationDetailsServiceV2.getDeviceAssosiationDetails(userId);
        Assertions.assertNotNull(deviceAssosiationDetails);
    }

    @Test
    public void getDeviceAssosiationDetails_EmptyDetailsList() {
        String userId = "User123";
    ...
    @Test
    public void getDeviceAssosiationDetails_NullDeviceDetail() {
    ...
    @Test
    public void getDeviceAssosiationDetails_ValidData() {
